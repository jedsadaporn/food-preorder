...
export default function DashboardMenuPage() {
  ...
  const deleteCategory = async (cat) => {
    ...
    if (itemsInCat.length > 0) {
      alert(`ลบไม่ได้ หมวด "${cat.name}" มีเมนู ${itemsInCat.length} รายการอยู่ ต้องลบเมนูก่อน`);
      return;
    }
    setDeleteTarget(cat);
  ...
  const saveItem = async () => {
    ...
    if (editingItem) {
      ...
      const maxOrder = itemsInCat.length > 0
        ? Math.max(...itemsInCat.map(i => i.sort_order)) + 1
        : 1;
        ...
        <div className="flex items-center justify-between mb-6">
          ...
          <div className="flex gap-2">
            <button
              ...
              className="bg-white hover:bg-gray-50 text-gray-700 text-sm font-bold px-4 py-2.5 rounded-xl border-2 border-gray-200 transition-colors"
            >
              + หมวดหมู่
            </button>
            <button
              onClick={() => openAddItem("")}
              className="bg-orange-600 hover:bg-orange-700 text-white text-sm font-bold px-4 py-2.5 rounded-xl transition-colors shadow-sm shadow-orange-200"
            >
              + เมนู
            </button>
          </div>
                  ...
                  <div className="flex items-center justify-between px-5 py-3 bg-gray-50 border-b border-gray-100">
                    ...
                    <div className="flex items-center gap-1">
                      <button
                        ...
                        className="text-orange-600 hover:bg-orange-50 text-xs font-bold px-3 py-1.5 rounded-lg transition-colors"
                      >
                        + เพิ่มเมนู
                      </button>
                      <button
                      ...
                      <button
                        ...
                        className="text-gray-400 hover:text-red-500 hover:bg-red-50 w-8 h-8 rounded-lg flex items-center justify-center transition-colors"
                      >
                        🗑️
                      </button>
                    </div>
            ...
            <div className="bg-white rounded-2xl w-full max-w-sm p-6 shadow-2xl">
              ...
              <div className="flex gap-2 mt-5">
                ...
                <button
                  ...
                  disabled={saving}
                  className="flex-1 py-3 rounded-xl text-sm font-bold text-white bg-orange-600 hover:bg-orange-700 transition-colors disabled:bg-gray-300"
                >
      ...
      {showItemModal && (
        <>
          ...
          <div className="fixed inset-0 z-50 flex items-end sm:items-center justify-center px-4">
            <div className="bg-white rounded-t-2xl sm:rounded-2xl w-full max-w-sm p-6 shadow-2xl max-h-[85vh] overflow-y-auto">
              <h3 className="text-lg font-black text-gray-900 mb-4">
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <textarea
                    rows={2}
                    placeholder="เช่น กุ้งแม่น้ำตัวใหญ่ เผาไฟแรง"
                    value={itemDesc}
                ...
                <div className="flex items-center justify-between bg-gray-50 rounded-xl px-4 py-3">
                  ...
                  <button
                    ...
                    className={`w-12 h-7 rounded-full transition-colors relative ${
                      itemAvailable ? "bg-green-500" : "bg-gray-300"
                    }`}
                  >
                    <div
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center px-4">
            <div className="bg-white rounded-2xl w-full max-w-sm p-6 shadow-2xl text-center">
              ...
              <div className="flex gap-2 mt-5">
                ...
                <button
                  onClick={deleteType === "category" ? confirmDeleteCategory : confirmDeleteItem}
                  className="flex-1 py-3 rounded-xl text-sm font-bold text-white bg-red-500 hover:bg-red-600 transition-colors"
                >
                  ลบเลย
                </button>
              </div>
